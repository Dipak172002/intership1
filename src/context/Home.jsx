...
function Home() {
  ...
  return (
    ...
    <div className="">
      <div className='min-h-screen min-w-screen border-b border-default pt-25 '>
          ...
          <div className='ui divider p-8 text-center'>
            <div className='field '>
              ...
              <div className='feild py-1'>
                ...
                <input type="weight" name='Id' value={values.weight} placeholder=' kg/lt/peice..' className="border-1 border-white-300 px-2 rounded-md w-short" onChange={(event) => setValues({ ...values, weight: event.target.value })} />
              </div>
            </div>

            <div className='feild py-1'>
              <label>Product Price : </label>
              <input type="number" name='weight' value={values.price} placeholder=' price....' className="border-1 border-white-300 px-2 rounded-md w-short " onChange={(event) => setValues({ ...values, price: event.target.value })} />
            </div>
            <div>
            </div>
              ...
              <label htmlFor='file-upload'>
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-white/70 border-2 px-6 py-10 ">
                  <div className="text-center">
                    <svg viewBox="0 0 24 24"  data-slot="icon" aria-hidden="true" className="mx-auto size-10 text-gray-600">
